                ...
                return _Mad_ord_mast.Mad_ord_mast.findAll({
                  where: (0, _defineProperty2['default'])(
                    ...
                    [
                      ...
                      {
                        check_mark: (0, _defineProperty2['default'])(
                          {},
                          _sequelize.Op.eq,
                          'N',
                        ),
              ...
              case 4:
                ...
                _lodash['default'].forEach(User, function (field) {
                  ...
                  if (params.isTime == 'morning') {
                    ...
                    message +=
                      'Walau sudah siang, kita harus tetap semangat!\n            \nBerikut ini ada tambahan PO Outstanding yang perlu diaudit:\n'
                  }
                  _lodash['default'].forEach(Pu, function (record, i) {
                    message += '\n'
                      .concat(i + 1, '. ')
                      .concat(record.sheet_no, '\u2502Amount: ')
                      .concat(record.mny_no, ' ')
                      .concat((record.amt * 1).toLocaleString())
                  })
                  message += '\n\nMohon dilakukan verifikasinya ya '
                    .concat(field.gender, '. ')
                    .concat(
                      field.name,
