              ...
              case 0:
                ...
                return _MntnWoModel.MntnWoModel.findAll({
                  where: (0, _defineProperty2['default'])(
                    ...
                    _sequelize.Op.and,
                    [
                      _sequelize.Sequelize.where(
                        _sequelize.Sequelize.fn(
                          'date',
                          _sequelize.Sequelize.col('ymd'),
                        ),
                        '>=',
                        (0, _dateFns.format)(new Date(), 'yyyy-MM-dd'),
                      ),
                      {
                        sts_wa: (0, _defineProperty2['default'])(
                          {},
                          _sequelize.Op.eq,
                          'N',
                        ),
                                      ...
                                      function (field) {
                                        if (
                                          ...
                                          msg += '\n\n*Stoptime:* '
                                            ...
                                            .concat(record.mch_no, ' | ')
                                            .concat(record.dep_no, ' | ')
                                            .concat(
                                              record.com_no == '01'
                                                ? 'GM1'
                                                : record.com_no == '02'
                ...
                return _MntnWoModel.MntnWoModel.findAll({
                  where: (0, _defineProperty2['default'])(
                    ...
                    [
                      ...
                      {
                        chk_mark: (0, _defineProperty2['default'])(
                          {},
                          _sequelize.Op.eq,
                          'Y',
                        ),
                        sts_wa2: (0, _defineProperty2['default'])(
                          {},
                          _sequelize.Op.eq,
                          'n',
                        ),
                                      ...
                                      /*#__PURE__*/ (function () {
                                        ...
                                        _asyncToGenerator2['default'])(
                                          /*#__PURE__*/ _regenerator[
                                            'default'
                                          ].mark(function _callee7(record, i) {
                                            return _regenerator['default'].wrap(
